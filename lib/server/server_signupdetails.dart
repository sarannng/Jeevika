...
class ServerSignupDetails extends StatefulWidget {
  @override
  _ServerSignupDetailsState createState() => _ServerSignupDetailsState();
}

class _ServerSignupDetailsState extends State<ServerSignupDetails> {
  @override
